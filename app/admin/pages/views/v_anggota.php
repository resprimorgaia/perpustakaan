                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" name="kElas">
                                                                ...
                                                                <!-- X -->
                                                                <option value="X - Teknik Komputer dan Jaringan">X - Teknik Komputer dan Jaringan A</option>
                                                                <option value="X - Teknik Komputer dan Jaringan">X - Teknik Komputer dan Jaringan B</option>
                                                                <option value="X - Teknik Sepeda Motor">X - Teknik Sepeda Motor A</option>
                                                                <option value="X - Teknik Sepeda Motor">X - Teknik Sepeda Motor B</option>
                                                                <!-- XI -->
                                                                <option disabled>------------------------------------------</option>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="kelas">
                            ...
                            <!-- XI -->
                            <option disabled>------------------------------------------</option>
                            <option value="XI - Teknik Komputer dan Jaringan">XI - Teknik Komputer dan Jaringan A</option>
                            <option value="XI - Teknik Komputer dan Jaringan">XI - Teknik Komputer dan Jaringan B</option>
                            <option value="XI - Teknik Sepeda Motor">XI - Teknik Sepeda Motor A</option>
                            <option value="XI - Teknik Sepeda Motor">XI - Teknik Sepeda Motor B</option>
                            <!-- XI -->
                            <option disabled>------------------------------------------</option>
                            <option value="XII - Teknik Komputer dan Jaringan">XII - Teknik Komputer dan Jaringan A</option>
                            <option value="XII - Teknik Komputer dan Jaringan">XII - Teknik Komputer dan Jaringan B</option>
                            <option value="XII - Teknik Sepeda Motor">XII - Teknik Sepeda Motor A</option>
                            <option value="XII - Teknik Sepeda Motor">XII - Teknik Sepeda Motor B</option>
                        </select>
                    </div>
                    <div class="form-group">
