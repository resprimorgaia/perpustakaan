...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <h2 class="text-center" style="font-family: Quicksand, sans-serif;">Perpustakaan SMKN 1 Kwanyar</h2>
        <p class="text-center">Alamat : Jl. Raya Sumur Koneng Kec. Kwanyar, Kabupaten Bangkalan, Jawa Timur</p>
    </section>
    <!-- /.content -->
</div>